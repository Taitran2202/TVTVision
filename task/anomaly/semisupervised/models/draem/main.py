...
def run(cfg):
    ...
    loss_name = "MSE Loss, SSIM Loss and Focal Loss"
    ...
    training(
        ...
        criterion=[l2_criterion, s_criterion, f_criterion],
        optimizer=optimizer,
        scheduler=scheduler,
        num_training_steps=cfg.TRAIN.num_training_steps,
        loss_weights=[cfg.TRAIN.l2_weight,
                      cfg.TRAIN.ssim_weight, cfg.TRAIN.focal_weight],
