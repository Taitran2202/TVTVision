...
from .model import ADFA
from ...plot_image import plot_image
from .tool import training
from ...data import create_dataset, create_dataloader
from .loss import ADFALoss
...
def run(cfg):
    ...
    # loss
    adfa_criterion = ADFALoss(
        num_nearest_neighbors=cfg.MODEL.num_nearest_neighbors,
        num_hard_negative_features=cfg.MODEL.num_hard_negative_features,
        radius=cfg.MODEL.radius
    )
