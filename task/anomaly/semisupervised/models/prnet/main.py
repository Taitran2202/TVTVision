...
from ...loss_function import FocalLoss, SmoothL1Loss, BinaryFocalLoss
...
def run(cfg):
    ...
    memoryloader = create_dataloader(
        dataset=memoryset,
        is_train=False,
        batch_size=cfg.DATALOADER.batch_size,
        num_workers=cfg.DATALOADER.num_workers
    ...
    model.to(device)
    model.initialize_proto_feature_maps(memoryloader)
