...
class ResNet(nn.Module):
    ...
    def __init__(self, name: str, res5_dilation: bool, norm_type: str, pretrained_weights: str = "imagenet1k_v1"):
        ...
        self.feat_dims = [128, 256, 512] if name in (
            'resnet18', 'resnet34') else [512, 1024, 2048]
        # Freeze
...
# build backbone
def build_backbone(cfg, pretrained_weight=None):
    # ResNet series
    backbone = ResNet(cfg.backbone, cfg.res5_dilation,
                      cfg.backbone_norm, pretrained_weight)
