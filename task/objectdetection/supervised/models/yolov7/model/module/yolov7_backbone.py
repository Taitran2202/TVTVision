...
class ELANNet_Nano(nn.Module):
    def __init__(self, act_type='lrelu', norm_type='BN', depthwise=True):
        ...
        # P1/2
        self.layer_1 = Conv(3, 16, k=3, p=1, s=2, act_type=act_type,
                            norm_type=norm_type, depthwise=depthwise)
        # P2/4
        self.layer_2 = nn.Sequential(
            Conv(16, 32, k=3, p=1, s=2, act_type=act_type,
                 norm_type=norm_type, depthwise=depthwise),
...
class ELANNet_Tiny(nn.Module):
    ...
    def __init__(self, act_type='silu', norm_type='BN', depthwise=False):
        ...
        # P1/2
        self.layer_1 = Conv(3, 32, k=3, p=1, s=2, act_type=act_type,
                            norm_type=norm_type, depthwise=depthwise)
        # P2/4
        self.layer_2 = nn.Sequential(
...
class ELANNet_Lagre(nn.Module):
    def __init__(self, act_type='silu', norm_type='BN', depthwise=False):
        ...
        self.layer_1 = nn.Sequential(
            Conv(3, 32, k=3, p=1, act_type=act_type,
                 norm_type=norm_type, depthwise=depthwise),
            Conv(32, 64, k=3, p=1, s=2, act_type=act_type,
                 norm_type=norm_type, depthwise=depthwise),
            Conv(64, 64, k=3, p=1, act_type=act_type,
                 norm_type=norm_type, depthwise=depthwise)
        )
        # P2/4
        self.layer_2 = nn.Sequential(
            Conv(64, 128, k=3, p=1, s=2, act_type=act_type,
                 norm_type=norm_type, depthwise=depthwise),
        ...
        # P3/8
        self.layer_3 = nn.Sequential(
            DownSample(in_dim=256, out_dim=256, act_type=act_type,
                       norm_type=norm_type, depthwise=depthwise),
        ...
        # P4/16
        self.layer_4 = nn.Sequential(
            DownSample(in_dim=512, out_dim=512, act_type=act_type,
                       norm_type=norm_type, depthwise=depthwise),
        ...
        # P5/32
        self.layer_5 = nn.Sequential(
            DownSample(in_dim=1024, out_dim=1024, act_type=act_type,
                       norm_type=norm_type, depthwise=depthwise),
...
class ELANNet_Huge(nn.Module):
    def __init__(self, act_type='silu', norm_type='BN', depthwise=False):
        ...
        # P1/2
        self.layer_1 = nn.Sequential(
            Conv(3, 40, k=3, p=1, act_type=act_type,
                 norm_type=norm_type, depthwise=depthwise),
            Conv(40, 80, k=3, p=1, s=2, act_type=act_type,
                 norm_type=norm_type, depthwise=depthwise),
            Conv(80, 80, k=3, p=1, act_type=act_type,
                 norm_type=norm_type, depthwise=depthwise)
        )
        # P2/4
        self.layer_2 = nn.Sequential(
            Conv(80, 160, k=3, p=1, s=2, act_type=act_type,
                 norm_type=norm_type, depthwise=depthwise),
        ...
        # P3/8
        self.layer_3 = nn.Sequential(
            DownSample(in_dim=320, out_dim=320, act_type=act_type,
                       norm_type=norm_type, depthwise=depthwise),
        ...
        # P4/16
        self.layer_4 = nn.Sequential(
            DownSample(in_dim=640, out_dim=640, act_type=act_type,
                       norm_type=norm_type, depthwise=depthwise),
        ...
        # P5/32
        self.layer_5 = nn.Sequential(
            DownSample(in_dim=1280, out_dim=1280, act_type=act_type,
                       norm_type=norm_type, depthwise=depthwise),
