...
class YOLOLoss(object):
    def __init__(self, loss_obj_weight, loss_cls_weight, loss_box_weight, iou_thresh, anchor_size, device, num_classes=80):
        self.device = device
        ...
        # matcher
        self.matcher = Yolov4Matcher(
            num_classes, 3, anchor_size, iou_thresh)
