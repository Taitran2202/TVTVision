...
from .rttdetv2_basic import Conv, ELANBlock, DSBlock
...
def build_backbone(cfg, pretrained=False):
    # model
    backbone = ELANNetv2(cfg['width'], cfg['depth'],
                         cfg['bk_act'], cfg['bk_norm'], cfg['bk_depthwise'])
    ...
    feat_dims = backbone.feat_dims[-4:]
