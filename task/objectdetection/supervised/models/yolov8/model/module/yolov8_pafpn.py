...
class Yolov8PaFPN(nn.Module):
    def __init__(self,
        ...
        self.width = width
        self.depth = depth
        self.out_dim = [round(256 * width), round(512 *
                                                  width), round(512 * width * ratio)]
        c3, c4, c5 = in_dims
        ...
        # ---------------- Bottom up ----------------
        # P3 -> P4
        self.dowmsample_layer_1 = Conv(round(256*width), round(256*width), k=3,
        ...
        # P4 -> P5
        self.dowmsample_layer_2 = Conv(round(512*width), round(512*width), k=3,
                                       p=1, s=2, act_type=act_type, norm_type=norm_type, depthwise=depthwise)
