...
def training(model, trainloader, validloader, criterion, optimizer, scheduler, num_training_steps: int = 1000, loss_weights: List[float] = [0.6, 0.4],
    ...
    # criterion
    l2_criterion, ssim_criterion, focal_criterion = criterion
    l2_weight, ssim_weight, focal_weight = loss_weights
    ...
    while train_mode:
        ...
        for inputs, targets in trainloader:
            ...
            loss = (l2_weight * l2_loss) + (ssim_weight *
                                            ssim_loss) + (focal_weight * focal_loss)
