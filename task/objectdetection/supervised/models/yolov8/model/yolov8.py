...
from .module import build_backbone, build_neck, build_fpn, build_det_head, build_pred_layer


class YOLOv8(nn.Module):
    def __init__(self, cfg, device, num_classes=20, conf_thresh=0.01, nms_thresh=0.5, topk=1000, no_decode=False):
        ...
        self.det_heads = build_det_head(
            cfg, self.fpn_dims, self.num_levels, num_classes, self.reg_max)
