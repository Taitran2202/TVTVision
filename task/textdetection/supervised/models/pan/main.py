...
def visualize_augmentations(dataset, samples=2):
    ...
    for j, data in enumerate(loader):
        ...
        plot_image(image[0].permute(1, 2, 0), gt_texts[0].squeeze(
        ), gt_kernels[0].squeeze(), training_masks[0].squeeze(), gt_instances[0].squeeze())
...
def run(cfg):
    ...
    fit(
        ...
        loss_weights=[cfg.TRAIN.text_weight,
                      cfg.TRAIN.kernel_weight, cfg.TRAIN.emb_weight],
