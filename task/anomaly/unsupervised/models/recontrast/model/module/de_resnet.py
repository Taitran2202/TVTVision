    ...
    def __init__(
        ...
        if output_conv > 0:
            ...
            for i in range(output_conv):
                self.out1.append(
                    nn.Conv2d(64 * block.expansion, 64 * block.expansion, 1))
                self.out2.append(
                    nn.Conv2d(128 * block.expansion, 128 * block.expansion, 1))
                self.out3.append(
                    nn.Conv2d(256 * block.expansion, 256 * block.expansion, 1))
            if uncertainty_conv:
