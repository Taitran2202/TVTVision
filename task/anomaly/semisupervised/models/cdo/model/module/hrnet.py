...
model_urls = {
    'hrnet18_imagenet': 'https://github.com/HRNet/HRNet-Image-Classification/releases/download/v0.0.1/hrnetv2_w18_imagenet_pretrained.pth',
    'hrnet32_imagenet': 'https://github.com/HRNet/HRNet-Image-Classification/releases/download/v0.0.1/hrnetv2_w32_imagenet_pretrained.pth',
    'hrnet48_imagenet': 'https://github.com/HRNet/HRNet-Image-Classification/releases/download/v0.0.1/hrnetv2_w48_imagenet_pretrained.pth',
}
...
def _hrnet(arch, pretrained, progress, **kwargs):
    ...
    if pretrained:
        ...
        model.load_state_dict(torch.load(
            f'task/anomaly/semisupervised/models/cdo/hr_weights/{arch}_imagenet.pth', map_location='cpu'), strict=False)
    return model
