import numpy as np
from task.objectdetection.supervised.utils.nms import multiclass_nms
...
class PostProcessor(object):
    def __init__(self, img_size, strides, num_classes, conf_thresh=0.15, nms_thresh=0.5, is_anchor=True):
    ...
    def generate_anchors(self):
        ...
        for stride in self.strides:
            ...
            anchor_x, anchor_y = np.meshgrid(
                np.arange(fmp_w), np.arange(fmp_h))
            # [H, W, 2]
    ...
    def decode_boxes(self, anchors, pred_regs):
        ...
        """
        # center of bbox
        pred_ctr_xy = anchors[..., :2] + \
            pred_regs[..., :2] * self.expand_strides
        # size of bbox
