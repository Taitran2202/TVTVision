...
from .rttdet_basic import Conv, CSPBlock
from .rttdet_neck import SPPF
...
class CSPDarkNet(nn.Module):
    def __init__(self, depth=1.0, width=1.0, act_type='silu', norm_type='BN', depthwise=False):
        ...
        self.feat_dims = [int(128*width), int(256*width), int(512*width), int(1024*width)]
...
def build_backbone(cfg, pretrained=False):
    ...
    """
    backbone = CSPDarkNet(cfg['depth'], cfg['width'],
                          cfg['bk_act'], cfg['bk_norm'], cfg['bk_dpw'])
