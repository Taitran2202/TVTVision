...
def run(cfg):
    ...
    s_criterion = SSIMLoss(window_size=cfg.TRAIN.ssim_window_size)
    ...
    loss_name = "MSE Loss, SSIM Loss, Focal Loss and L1 Loss"
    ...
    training(
        ...
        criterion=[l2_criterion, s_criterion, l1_criterion, f_criterion],
        optimizer=optimizer,
        scheduler=scheduler,
        num_training_steps=cfg.TRAIN.num_training_steps,
        loss_weights=[cfg.TRAIN.l2_weight, cfg.TRAIN.ssim_weight,
                      cfg.TRAIN.l1_weight, cfg.TRAIN.focal_weight],
