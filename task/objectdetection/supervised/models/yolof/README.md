...
- [yolofdataset](https://github.com/pntrungbk15/TNVision/blob/main/tasks/objectdetection/supervised/data/dataset.py)


## 2. Model Process 

- [model](https://github.com/pntrungbk15/TNVision/blob/main/tasks/objectdetection/supervised/models/yolof/model/yolof.py)

<p align='center'>
    <img width='1500' src='assets/yolof.png'>
</p>

# Run

```bash
python main.py --task_type objectdetection --model_type supervised --model_name yolof --yaml_config configs/objectdetection/supervised/yolof/pascal.yaml
```
