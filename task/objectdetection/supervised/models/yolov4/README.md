...
- [yolov4dataset](https://github.com/pntrungbk15/TNVision/blob/main/tasks/objectdetection/supervised/data/dataset.py)


## 2. Model Process 

- [model](https://github.com/pntrungbk15/TNVision/blob/main/tasks/objectdetection/supervised/models/yolov4/model/yolov4.py)

<p align='center'>
    <img width='1500' src='assets/yolov4.png'>
</p>
