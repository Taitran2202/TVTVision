...
class CATS(nn.Module):
    ...
    def forward(self, x):
        ...
        upsample2 = F.conv_transpose2d(
            so2_out, self.weight_deconv2, stride=2)
        upsample3 = F.conv_transpose2d(
            so3_out, self.weight_deconv3, stride=4)
        upsample4 = F.conv_transpose2d(
            so4_out, self.weight_deconv4, stride=8)
        upsample5 = F.conv_transpose2d(
            so5_out, self.weight_deconv5, stride=8)
