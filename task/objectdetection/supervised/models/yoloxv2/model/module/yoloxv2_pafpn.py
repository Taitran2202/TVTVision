...
class Yolox2PaFPN(nn.Module):
    def __init__(self,
        ...
        self.reduce_layer_1 = Conv(
            c5, round(512*width), k=1, act_type=act_type, norm_type=norm_type)
        ...
        self.reduce_layer_2 = Conv(
            round(512*width), round(256*width), k=1, act_type=act_type, norm_type=norm_type)
        ...
        # ---------------- Bottom up ----------------
        # P3 -> P4
        self.downsample_layer_1 = Conv(round(256*width), round(256*width), k=3,
                                       p=1, s=2, act_type=act_type, norm_type=norm_type, depthwise=depthwise)
        ...
        # P4 -> P5
        self.downsample_layer_2 = Conv(round(512*width), round(512*width), k=3,
                                       p=1, s=2, act_type=act_type, norm_type=norm_type, depthwise=depthwise)
